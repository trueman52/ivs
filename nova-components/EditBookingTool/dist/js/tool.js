...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_js_modal__ = __webpack_require__(3);
...
var update = __webpack_require__(8)("7b4ff001", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../nova-components/EditBookingTool/node_modules/css-loader/index.js!../../../nova-components/EditBookingTool/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-68ff5483\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../../nova-components/EditBookingTool/node_modules/css-loader/index.js!../../../nova-components/EditBookingTool/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-68ff5483\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
var endpoint = '/nova-vendor/edit-booking-tool';
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        removeBookingCoupon: function removeBookingCoupon() {
        ...
        save: function save() {
            ...
            axios.put(endpoint + '/bookings/' + this.booking.id, {
                ...
                _this.$modal.hide('confirm');

                _this.$toasted.success('Booking has been updated.');

                _this.$router.push({
                    name: 'detail',
                    params: {
                        resourceName: 'bookings',
                        resourceId: _this.booking.id
                    }
                });
            }).catch(function (e) {
                _this.errors = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatten"])(Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["toArray"])(e.response.data.errors));

                _this.$toasted.error('Unable to perform update on booking.');
            });
        },
        calculate: function () {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 5;
                                return axios.get(endpoint + '/calculate-booking', {
                                    params: {
                                        unitId: this.booking.unitId,
                                        booking: this.booking,
                                        quantity: this.quantity,
                                    ...
                                    _this2.errors = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatten"])(Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["toArray"])(e.response.data.errors));
                                    _this2.$toasted.error('Unable to perform calculation on booking.');
                                });

                            case 5:
                                this.calculation = _context.sent;
         ...
         * @return {Array}
         */
        selectedPeriodUnitIdsApiData: function selectedPeriodUnitIdsApiData() {
            return Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatMap"])(this.selectedPeriods, function (period) {
         ...
         * @return {String}
         */
        addOnsApiData: function addOnsApiData() {
            var bookingAddOns = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatMap"])(this.bookingAddOns, function (bookingAddOn) {
                return {
            ...
            var newAddOns = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatMap"])(this.newAddOns, function (addOn) {
                return {
                    id: addOn.addOn.id,
         ...
         * @return {String}
         */
        adhocItemsApiData: function adhocItemsApiData() {
            var joined = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["concat"])(this.bookingAdhocItems, this.newAdhocItems);

            return JSON.stringify(Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["map"])(joined, function (item) {
                // map all properties when trying to convert the
                // amounts to cents, the original object gets mutated.
                var duplicate = _extends({}, item);
         ...
         * @param {string} prop
         */
        updateNewAdhocItem: function updateNewAdhocItem(value, key, prop) {
         ...
         * @return {string}
         */
        periodLabel: function periodLabel(_ref2) {
         ...
         * @param id
         */
        getUnitInformation: function getUnitInformation(id) {
         ...
         */
        removeBookingAddOn: function removeBookingAddOn(key) {
         ...
         */
        removeNewAddOn: function removeNewAddOn(key) {
         ...
         */
        insertAddOnRow: function insertAddOnRow() {
         ...
         */
        insertAdhocRow: function insertAdhocRow() {
         ...
         * @return {string}
         */
        couponLabel: function couponLabel(_ref3) {
            var data = _ref3.data;
         ...
         * @return {string}
         */
        makeUniqueKey: function makeUniqueKey() {
         ...
         */
        removeAdhocRow: function removeAdhocRow(key) {
            console.log(key);
         ...
         */
        removeBookingAdhocItems: function removeBookingAdhocItems(key) {
        ...
        initDefaultState: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
                ...
                var bookingRes, couponRes, unitRes;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 8:
                                ...
                                _context2.next = 13;
                                return this.getUnitInformation(this.booking.unitId);
                            ...
                            case 13:
                                ...
                                this.selectableAddOns = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["flatMap"])(this.unit.addOnGroups, function (group) {
                                    return group.addOns;
                                });

                                // Get the booking period's id and find the matching unit period's id.
                                this.selectedPeriods = Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["map"])(this.booking.bookingPeriods, function (bookingPeriod) {
                                    return Object(__WEBPACK_IMPORTED_MODULE_1_lodash__["find"])(_this3.unit.periods, { id: bookingPeriod.periodId });
                                });
    ...
    filters: {
        parseDbDate: function parseDbDate(date) {
            if (!date) return '';
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Edit Booking")]),
      _vm._v(" "),
      _vm.booking
        ? _c("card", { staticClass: "flex flex-col" }, [
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "w-1/2 py-6 px-8" }, [
                _c("input", {
                  staticClass:
                    "w-full form-control form-input form-input-bordered px-2 w-1/3",
                  attrs: { disabled: "disabled" },
                  domProps: { value: _vm.booking.spaceName }
                })
              ])
            ]),
            _vm._v(" "),
              ...
              _c("div", { staticClass: "w-1/2 py-6 px-8" }, [
                _c("input", {
                  staticClass:
                    "w-full form-control form-input form-input-bordered px-2 w-1/3",
                  attrs: { disabled: "disabled" },
                  domProps: { value: _vm.booking.unitName }
                })
              ])
            ]),
            _vm._v(" "),
              ...
              ? _c("div", { staticClass: "flex border-b border-40" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("multiselect", {
                        attrs: {
                          "custom-label": _vm.periodLabel,
                          "track-by": "id",
                          options: _vm.unit.periods,
                          multiple: true,
                          "hide-selected": true,
                        ...
                        model: {
                          value: _vm.selectedPeriods,
                          callback: function($$v) {
                            _vm.selectedPeriods = $$v
                          },
                          expression: "selectedPeriods"
                        }
                      })
                    ],
                    1
            ...
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c(
                "div",
                { staticClass: "w-3/4 py-6 px-8 self-end" },
                [
                  _vm._l(_vm.bookingAddOns, function(bookingAddOn, key) {
                    return _c(
                      "div",
                      {
                        key: bookingAddOn.id,
                        staticClass: "-mx-2 flex flex-wrap pb-3"
                      },
                      [
                        _c("div", { staticClass: "px-2 w-1/3" }, [
                          _c("input", {
                            ...
                            domProps: {
                              value:
                                bookingAddOn.addOn.frontendName +
                                " (" +
                                _vm.$options.filters.money(
                                  bookingAddOn.purchasedAt
                                ) +
                                ")"
                            }
                          })
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: bookingAddOn.quantity,
                                expression: "bookingAddOn.quantity"
                              }
                            ],
                            staticClass:
                              "w-full form-control form-input form-input-bordered",
                            domProps: { value: bookingAddOn.quantity },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                        ...
                        _c("div", { staticClass: "px-2 w-1/3" }, [
                          _c(
                            ...
                            {
                              staticClass:
                                "text-primary font-semibold p-2 cursor-pointer inline-block",
                              on: {
                                click: function($event) {
                                  return _vm.removeBookingAddOn(key)
                                }
                              }
                            },
                            [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.newAddOns, function(addOn, key) {
                    return _c(
                      "div",
                      {
                        key: addOn.key,
                      ...
                      [
                        _c(
                          "div",
                          { staticClass: "px-2 w-1/3" },
                          [
                            _c("multiselect", {
                              attrs: {
                                label: "frontendName",
                                "track-by": "id",
                                options: _vm.selectableAddOns,
                                "clear-on-select": false,
                              ...
                              model: {
                                value: _vm.newAddOns[key].addOn,
                                callback: function($$v) {
                                  _vm.$set(_vm.newAddOns[key], "addOn", $$v)
                                },
                                expression: "newAddOns[key].addOn"
                              }
                            })
                          ],
                          1
                            ...
                            directives: [
                              {
                                ...
                                expression: "addOn.quantity"
                              }
                            ],
                            staticClass:
                              "w-full form-control form-input form-input-bordered",
                            domProps: { value: addOn.quantity },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.$set(addOn, "quantity", $event.target.value)
                              }
                            }
                          })
                        ]),
            ...
            _vm.bookingCoupon
                    ...
                    _c("div", { staticClass: "flex flex-wrap -mx-2" }, [
                      _c("div", { staticClass: "w-1/2 px-2" }, [
                        _c("input", {
                          ...
                          domProps: {
                            value:
                              _vm.bookingCoupon.data.coupon_details.data.title
                          }
                        })
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "w-1/2 px-2" }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "text-primary font-semibold p-2 cursor-pointer",
                            on: {
                              click: function($event) {
                                return _vm.removeBookingCoupon()
                              }
                            }
                          },
                          [
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.selectableCoupons.length > 0 && !_vm.bookingCoupon
              ? _c("div", { staticClass: "flex border-b border-40" }, [
                  _c("div", { staticClass: "w-1/5 py-6 px-8" }, [
                    _c(
                      "label",
                  ...
                  _c(
                    ...
                    [
                      _c("multiselect", {
                        attrs: {
                          "custom-label": _vm.couponLabel,
                          "track-by": "id",
                          options: _vm.selectableCoupons,
                          ...
                          [
                            {
                              ...
                              fn: function(props) {
                                return [
                                  _c("div", { staticClass: "option__title" }, [
                                    _vm._v(_vm._s(props.option.data.title))
                                  ])
                                ]
                              }
                            }
            ...
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c(
                ...
                { staticClass: "w-3/4 py-6 px-8 self-end" },
                [
                  _vm._l(_vm.bookingAdhocItems, function(
                    bookingAdhocItem,
                    key
                  ) {
                    return _c(
                      ...
                      [
                        _c("div", { staticClass: "px-2 w-1/4" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: bookingAdhocItem.name,
                                expression: "bookingAdhocItem.name"
                              }
                            ],
                            staticClass:
                              "w-full form-control form-input form-input-bordered",
                            attrs: { placeholder: "Item name" },
                            domProps: { value: bookingAdhocItem.name },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                        ...
                        _c("div", { staticClass: "px-2 w-1/4" }, [
                          _c("input", {
                            staticClass:
                              "w-full form-control form-input form-input-bordered",
                            attrs: { disabled: "disabled", placeholder: "S$" },
                            domProps: { value: bookingAdhocItem.amount / 100 }
                          })
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "px-2 w-1/4" }, [
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: bookingAdhocItem.quantity,
                                expression: "bookingAdhocItem.quantity"
                              }
                            ],
                            staticClass:
                              "w-full form-control form-input form-input-bordered",
                            attrs: { placeholder: "Qty" },
                            domProps: { value: bookingAdhocItem.quantity },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                        ...
                        _c("div", { staticClass: "px-2 w-1/4" }, [
                          _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.removeBookingAdhocItems(key)
                                }
                              }
                            },
                            [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.newAdhocItems, function(item, key) {
                    return _vm.newAdhocItems.length > 0
                      ? _c(
                          "div",
                          {
                            key: item.key,
                          ...
                          [
                            ...
                            _c("div", { staticClass: "px-2 w-1/4" }, [
                              _c("input", {
                                staticClass:
                                  "w-full form-control form-input form-input-bordered",
                                attrs: { placeholder: "Qty", type: "text" },
                                on: {
                                  change: function($event) {
                                    return _vm.updateNewAdhocItem(
                                      $event.target.value,
                  ...
                  _c(
                    "div",
                    {
                      staticClass:
                        "text-primary font-semibold p-2 cursor-pointer inline-block",
                      on: { click: _vm.insertAdhocRow }
                    },
                    [_vm._v("Add ad-hoc item\n                ")]
                  )
                ],
                2
              )
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.notifyCustomer,
                      expression: "notifyCustomer"
                    }
                  ],
                  attrs: { type: "checkbox" },
                  domProps: {
                    checked: Array.isArray(_vm.notifyCustomer)
                      ? _vm._i(_vm.notifyCustomer, null) > -1
                      : _vm.notifyCustomer
                  },
                  on: {
                    change: function($event) {
                      var $$a = _vm.notifyCustomer,
                        $$el = $event.target,
                      ...
                      if (Array.isArray($$a)) {
                        var $$v = null,
                          $$i = _vm._i($$a, $$v)
                        if ($$el.checked) {
                          $$i < 0 && (_vm.notifyCustomer = $$a.concat([$$v]))
                        } else {
                          $$i > -1 &&
                            (_vm.notifyCustomer = $$a
                              .slice(0, $$i)
                              .concat($$a.slice($$i + 1)))
                        }
                      } else {
                        _vm.notifyCustomer = $$c
                      }
                    }
                  }
                })
            ...
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c("div", { staticClass: "w-1/2 py-6 px-8" }, [
                _c("textarea", {
                  ...
                  domProps: { value: _vm.internalNotes },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.internalNotes = $event.target.value
                    }
                  }
                })
              ])
      ...
      _c(
        "button",
        {
          staticClass: "mt-6 btn btn-primary btn-default",
        ...
        [
          _c("div", { staticClass: "p-8" }, [
            _c("h2", { staticClass: "text-2xl font-normal" }, [
              _vm._v("Confirm booking for customer")
            ]),
            _vm._v(" "),
            _vm.calculation
              ? _c("div", { staticClass: "mt-4" }, [
                  _c("div", { staticClass: "border border-30" }, [
                    _c("div", { staticClass: "bg-30 p-4 text-90" }, [
                      _vm._v(
                        "\n                        Booking summary\n                    "
                      )
                    ]),
                    ...
                    _c(
                      "div",
                      { staticClass: "p-4 text-sm -my-4" },
                      [
                        _vm._l(_vm.calculation.periods.calculations, function(
                          item
                        ) {
                          return _c(
                            "div",
                            { staticClass: "py-4 border-b border-30" },
                            [
                              _c("div", { staticClass: "flex flex-wrap" }, [
                                _c("div", { staticClass: "pt-2 w-1/2" }, [
                                  _vm._v(
                                    _vm._s(item.date) +
                                      " x " +
                                ...
                                _c(
                                  "div",
                                  { staticClass: "pt-2 w-1/2 text-right" },
                                  [
                                    _vm._v(
                                      _vm._s(_vm._f("money")(item.total)) +
                                        "\n                                "
                                    )
                                  ]
                                )
                              ...
                              _vm._v(" "),
                              _vm._l(
                                _vm.calculation.addOns.calculations,
                                function(item) {
                                  return _c(
                                    "div",
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.calculation.appliedDiscounts, function(
                          item
                        ) {
                          return _c(
                            "div",
                            ...
                            [
                              _c("div", { staticClass: "flex flex-wrap" }, [
                                _c("div", { staticClass: "pt-2 w-1/2" }, [
                                  _vm._v(
                                    _vm._s(item.discount.name) +
                                      " (" +
                                      _vm._s(item.discount.discountValue) +
                                      ")"
                                  )
                                ]),
                                _vm._v(" "),
                                ...
                                _c("div", { staticClass: "flex flex-wrap" }, [
                                  _c("div", { staticClass: "pt-2 w-1/2" }, [
                                    _vm._v(
                                      "Coupon code: " +
                                        _vm._s(
                                          _vm.calculation.appliedCoupon.coupon
                                            .code
                                        )
                                    )
                                  ]),
                        ...
                        _vm._v(" "),
                        _vm._l(
                          _vm.calculation.adhocItems.calculations,
                          function(item) {
                            return _c(
                              "div",
                              { staticClass: "py-4 border-b border-30" },
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "py-4 border-b border-30" }, [
                          _c("div", { staticClass: "flex flex-wrap" }, [
                            _c("div", { staticClass: "pt-2 w-1/2" }, [
                              _vm._v("Subtotal")
                            ]),
                            ...
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("money")(_vm.calculation.subTotal)
                                  )
                                )
                              ]
                            ),
                            ...
                            _c("div", { staticClass: "pt-2 w-1/2" }, [
                              _vm._v(
                                "GST (" +
                                  _vm._s(_vm.calculation.gst.percentage) +
                                  "%)"
                              )
                            ]),
                            _vm._v(" "),
                        ...
                        _vm._v(" "),
                        _vm.calculation.securityDeposit
                          ? _c(
                              "div",
                              { staticClass: "py-4 border-b border-30" },
                              [
                          ...
                          _c("div", { staticClass: "flex flex-wrap" }, [
                            ...
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("money")(_vm.calculation.grandTotal)
                                  )
                                )
                              ]
                            )
